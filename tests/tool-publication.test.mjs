...
test("new installations publish the approved launch tools", async () => {
  ...
  assert.deepEqual(published, ["ai-music-studio", "ai-outfit-changer", "hang-la-tier-list-generator", "interview-assistant", "mbti-personality-test", "product-kill-line-analyzer", "stock-pet", "value-ranking-tool", "word-immersion"]);
