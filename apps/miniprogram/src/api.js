...
export const api = {
  ...
  register: (data) => request("/api/auth/register", { method: "POST", data: { ...data, legalAccepted: true, termsVersion: "2026-08-24", privacyVersion: "2026-08-24" } }),
  sendSms: (phone) => request("/api/auth/sms/send", { method: "POST", data: { phone } }),
  verifySms: (phone, code) => request("/api/auth/sms/verify", { method: "POST", data: { phone, code, name: "微信用户", locale: "zh-CN", legalAccepted: true, termsVersion: "2026-08-24", privacyVersion: "2026-08-24" } }).then(saveSession),
