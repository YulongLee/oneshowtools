...
export function WordImmersion({ tool, onBack, onCompleted }) {
  ...
  return <section className="wi-shell">
    ...
    <header className="wi-hero"><div className="wi-brand-icon"><BookOpenText size={36} weight="duotone" /></div><div><span>WORDIN · AI 沉浸式英语阅读 <i>测试中</i></span><h1>读你真正想读的，顺便学会英语</h1><p>将任何文章转化为循序渐进的沉浸式英文读物，让词汇在真实语境中自然发生。</p><div><small><Check weight="bold" />保留原意</small><small><Check weight="bold" />个性化词库</small><small><Check weight="bold" />学习轨迹</small></div></div><aside><strong>{tool.creditCost}</strong><span>积分 / 次</span></aside></header>
