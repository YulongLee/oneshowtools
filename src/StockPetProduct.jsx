  ...
  return <div className="stock-pet-page">
    ...
    <div className="stock-pet-commerce-grid">
      <main>
        ...
        {tab === "updates" && <section className="stock-pet-panel"><h3>{product?.version || "0.1.0-preview"}</h3><p>当前为商业化预览版本：账户权益、设备授权、行情接入能力和桌面安装包均已完成；正式行情服务、安装包公证签名、下载地址与自动更新源配置完成后发布。</p></section>}
