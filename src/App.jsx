...
const seoResultNames = {
  zh: { keywords: "关键词结果", content: "内容优化结果", audit: "诊断结果", ranking: "排名数据", backlinks: "外链数据", comparison: "差距对比", scorecard: "评分结果", report: "SEO 报告" },
  en: { keywords: "Keyword results", content: "Content result", audit: "Audit findings", ranking: "Ranking data", backlinks: "Backlink data", comparison: "Gap comparison", scorecard: "Scorecard", report: "SEO report" },
};
