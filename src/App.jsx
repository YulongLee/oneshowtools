...
function Billing({ plans, status, credits, user, tasks = [], locale, onCheckout, onPortal, onNavigate }) {
  ...
  const copy = isEn ? {
    ...
    paymentPending: "当前尚未启用支付通道，不会发起真实扣款。你仍可查看套餐，支付启用后即可购买。", manage: "管理付款与发票",
  ...
  const billingCopy = isEn ? {
    ...
    heading: "计费中心", headingSub: "按需选择积分充值或月度会员，两种方案独立展示。", overview: "本月使用概览", monthSpent: "本月消耗", monthEarned: "本月获得", entries: "流水笔数", todaySpent: "今日消耗", creditsTab: "积分充值", memberTab: "月度会员", creditHint: "一次性购买积分，长期有效，可用于所有已接入的工具和服务", account: "账户信息", manage: "管理订阅", needMore: "积分不够用？", needMoreBody: "充值积分，解锁更多强大工具和服务。", reasons: "为什么选择积分？", durable: "灵活通用", durableSub: "适用于所有已接入的工具和服务", secure: "安全可追踪", secureSub: "每次消耗都有清晰账本记录", value: "性价比高", valueSub: "更高档套餐包含额外赠送", recent: "最近消费", noSpend: "暂无积分消费记录", details: "积分明细",
  };
