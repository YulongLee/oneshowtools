...
const imageToolInitial = { format: "webp", targetKb: "200", width: "1200", height: "", preset: "xiaohongshu-cover", title: "一个网站，解决每天的小需求", subtitle: "简单、好用的 AI 工具平台", brand: "OneShowTools", accent: "#1769e8", watermark: "OneShowTools", opacity: "55", fontSize: "48", background: "#ffffff", tolerance: "48", language: "chi_sim+eng" };
const pdfToolFields = {
...
function ToolPage({ tool, catalog, task, historyTasks, locale, authenticated, runtime, account, onBack, onAuth, onCompleted, onModelChange }) {
  ...
  const fileMultiple = tool.slug === "batch-image-resizer" || pdfMultiple || tool.slug === "audio-merger" || tool.slug === "excel-merger";
