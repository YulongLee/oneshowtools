export const catalogs = Object.freeze({
  "zh-CN": Object.freeze({
    ...
    auth: { title: "欢迎使用 OneShowTools", google: "使用 Google 继续", or: "或者使用邮箱", googleUnavailable: "Google 登录尚未配置，请先使用邮箱登录。", signIn: "登录", signUp: "注册", email: "邮箱", password: "密码", name: "昵称", forgot: "忘记密码？", resetTitle: "重置密码", resetAction: "发送重置邮件", newPassword: "新密码", savePassword: "保存新密码", pending: "请查收验证邮件", pendingBody: "为了保护账户安全，验证邮箱后才能登录。", genericRecovery: "如果该邮箱已注册，你将收到重置邮件。", genericRegister: "请查收邮箱中的验证链接。", invalid: "操作未完成，请检查信息后重试。", close: "关闭" },
